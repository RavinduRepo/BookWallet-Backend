...
const addImage = async (req, res) => {
    try {
      ...
      // Insert a new row into the 'image' table with the image path
      const insertQuery = `INSERT INTO images (image) VALUES ('${imagePath}')`;
      const [result, _] = await sequelize.query(insertQuery);
